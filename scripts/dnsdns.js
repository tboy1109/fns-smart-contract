...
async function main() {
  const rsasha1algorithm = await ethers.getContractAt("RSASHA1Algorithm","0x85323467ec10357AE2817704b403d6E0996eB844")
  const rsasha256algorithm = await ethers.getContractAt("RSASHA256Algorithm","0xeD3697C5741a06503419E86adD90089E48A61BE6")
  const p256sha256algorithm = await ethers.getContractAt("P256SHA256Algorithm","0x3192Ba483b58acd83C122d4f3237e5b23d83A904")
  const sha1digest = await ethers.getContractAt("SHA1Digest","0xB3CfF716D8b7574A4e4c83F145f045C9DA584482")
  const sha256digest = await ethers.getContractAt("SHA256Digest","0xdd666886099BA524a8D266005B772E09bDbdba98")
  const sha1nsec3digest = await ethers.getContractAt("SHA1NSEC3Digest","0x6790e09A9ECd7a4Ceda50D2f809312eC909aC19A")
  const dnssecimpl = await ethers.getContractAt("DNSSECImpl","0xF405689153302c879e9D7204eDA5c6C572771192")
  const tldpublicsuffixlist = await ethers.getContractAt("TLDPublicSuffixList","0xAa3822b539Fbda5E128000691ba29426C3c0bEdf")
